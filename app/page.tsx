...
export const metadata: Metadata = buildPageMetadata({
  title: "Social0 Docs",
  description:
    "Documentation for the Social0 dashboard, CLI, API, and AI integrations.",
  path: "/",
});
    ...
    <main className="flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center px-6">
      <div className="max-w-xl text-center">
        ...
        <p className="mt-3 text-(--muted-foreground)">
          Documentation for the Social0 dashboard, CLI, API, and AI assistants.
        </p>
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/docs/integrations/cli/quickstart"
