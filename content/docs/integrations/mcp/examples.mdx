...
Same tools on **remote** (`https://mcp.social0.app/mcp`) and **local** (`npx -y @social0/mcp`). Tool names below match [MCP tools](/docs/integrations/mcp/tools).
...
- [CLI platform examples](/docs/integrations/cli/platform-examples) — preferred when the agent has a shell
