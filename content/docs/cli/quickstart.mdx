...
| Self-hosted API | Pass `--api-url` or set `SOCIAL0_API_URL` — see [Commands](/docs/cli/commands#custom-api-url--self-host) |

## Next

- [Commands reference](/docs/cli/commands)
- [REST API](/docs/api) for raw HTTP
- [MCP](/docs/mcp) **only** if the AI host has no shell
