...
API flow: [Upload media](/docs/api/guides/media) · CLI: [Commands — upload](/docs/integrations/cli/commands).
...
Details: [MCP troubleshooting](/docs/integrations/mcp/troubleshooting).
...
- [Media API reference](/docs/api/reference/media)
