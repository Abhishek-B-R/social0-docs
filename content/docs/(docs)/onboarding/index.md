---
title: "Onboarding"
description: "What happens when you first sign up: choose a plan, set a goal, connect accounts, and you're ready."
---

## Overview

When you first sign up, Social0 walks you through a short onboarding flow: choose a plan (or skip), pick a goal so we can tailor the experience, connect at least one social account, and you’re done. After that you land in the Dashboard and can start creating posts.
...
After connecting accounts and creating an [API key](/docs/dashboard/api-keys), you can manage Social0 from Claude, Cursor, or VS Code via the [MCP Server](/docs/mcp/quickstart). Ask your assistant to list accounts, draft posts, or publish — no dashboard required for day-to-day posting.
