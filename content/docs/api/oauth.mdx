...
| **OAuth (hosted MCP)** | [Social0 MCP](/docs/integrations/mcp) connector for AI hosts without a shell |
...
- Docs: [Social0 MCP](/docs/integrations/mcp)
...
- [Social0 MCP](/docs/integrations/mcp)
