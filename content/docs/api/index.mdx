---
title: "API Overview"
description: Getting started with the Social0 public REST API.
---
...
- **Who am I** — `GET /v1/me` for plan, timezone, and key metadata
...
- **Post events** — `GET /v1/posts/:id/events` for per-platform publish timeline
...
- [Developer apps](/docs/api/oauth) — API keys (REST) vs MCP OAuth
- [Provider settings](/docs/api/providers) — TikTok privacy, Pinterest boards, YouTube titles, threads
- [MCP Server](/docs/mcp) — manage posts from Claude, Cursor, or ChatGPT
