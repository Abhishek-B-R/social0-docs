...
The response includes `secret` once — store it immediately. See [Webhooks reference](/docs/api/reference/list-webhooks) for list, update, and delete endpoints.
...
- [Webhooks reference](/docs/api/reference/list-webhooks)
